  ...
  return (
    <div>
      <div className="flex flex-col border-[1px] border-gray-100 rounded-lg p-4  mb-10">
        <h1 className="text-2xl laptop:text-2xl font-bold mb-6">Details</h1>
      ...
      <div className="flex flex-col border-[1px] border-gray-100 rounded-lg p-4 ">
        <h1 className="text-2xl laptop:text-2xl font-bold mb-6">Description</h1>
        <h1 className="text-sm laptop:text-sm mb-2 ">
          {listingDetails?.description}
        </h1>
        {listingDetails?.highlight && <br />}
        <h1 className="text-lg laptop:text-xl font-semibold mb-6">
